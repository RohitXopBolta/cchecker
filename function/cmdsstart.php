...
$videoURLStart = "https://t.me/ManishCardingStore/5";


if (preg_match('/^(\/start|\.start|!start)/', $text)) {
    if (in_array($userId, $freeusers)) {
        $caption = "𝗪𝗲𝗹𝗰𝗼𝗺𝗲 <code>@$username</code> 𝘁𝗼 flamexmaster Checker 💖
        ...
        'inline_keyboard' => [
            [
                             ['text' => '𝙂𝘼𝙏𝙀𝙒𝘼𝙔𝙎', 'callback_data' => 'gates'],
                                 ...
                                 [
                                 ['text' => '@flamexmaster', 'callback_data' => 'channel'],
                             ],
        ]
    ]);

    $caption = "Welcome To flamexmaster. Buy The Plan First.  /price 
...

{
 ...
 $caption=" Pricing flamexmaster Checker📍
━━━━━━━━━━━━━━━━━━
⑄ 𝙎𝙐𝘽𝙎𝘾𝙍𝙄𝙋𝙏𝙄𝙊𝙉 𝙈𝙀𝙉𝙐 ⑄
━━━━━━━━━━━━━━━━━━
× 1 𝘞𝘌𝘌𝘒  - 3$
